...
// const ProductCard = ({ thumbnail,title,price,rating,dicountPercentage }) => {
// const {fetchProductById}=useContext(ProductContext)

// const filledStars = Math.round(rating || 3); // default 3 if not provided
//   const totalStars = 5;
//   return (
//     <div className="border rounded-xl p-4 shadow-md hover:shadow-lg transition" onClick={(id)=>fetchProductById(id)}>
//       <img src={thumbnail} alt={thumbnail} className="w-full h-40 object-cover rounded" />
...
//       <p> {dicountPercentage} </p>
//     <Button variant="contained" size="small" startIcon={<MdAddShoppingCart />}>
//   Add item
// </Button>
//     </div>
//   );
