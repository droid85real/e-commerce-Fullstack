...
const Trending = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 280,
      image:
        "https://images.unsplash.com/photo-1620012253295-c15cc3e65df4?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=765",
    },
  ];
    ...
    <div className="font-[Inter] bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start px-20 bg-gradient-to-r from-black/60 via-black/30 to-transparent text-white">
          ...
          <button className="bg-white text-black px-6 py-3 font-semibold rounded-full hover:bg-gray-200" onClick={() => navigate("/")}>
            Shop Now
          </button>
        </div>
      </section>
...
>
  Popular Collections
          ...
          <button className="text-gray-700 hover:underline"  onClick={() => navigate("/")}>
      ...
      <section className="px-10 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          />
          {/* <img
            src="https://images.unsplash.com/flagged/photo-1563807556028-4ee2b3253dbf?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=687"
            alt="Trending 2"
            className="rounded-2xl w-full h-[300px] object-cover"
          /> */}
          <img
